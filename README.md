...
![Version](https://img.shields.io/badge/version-0.31.0-blue) ![License](https://img.shields.io/badge/license-GPL--3.0-green) ![Platform](https://img.shields.io/badge/platform-JavaScript-lightgrey)
...
**Appearance**: `pageTheme` — an opt-in dark/OLED skin for old.reddit with selectable palettes (OLED Black, Graphite, Midnight, Catppuccin Mocha, Tokyo Night, Rosé Pine), accent colour, declutter, rounded corners, and a collapse-to-hover sidebar. The settings console has its own themes, including the light Paper theme.
