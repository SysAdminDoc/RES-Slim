...
export const DEFAULT_INSTANCE = 'https://api.cobalt.tools';
...
// attempt) so a dead public instance falls through to the next. Always returns
// at least the default instance.
export function parseInstanceList(raw: mixed): string[] {
	...
	return out.length ? out : [DEFAULT_INSTANCE];
}
