...
// dependency-free syntax tokenizer. Its only dependency is the shared HTML text
// escape.
...
// Re-exported under its old name: this module's own callers and its contract
// both use it, and it is the same function.
