...
export function downloadBlob(blob: Blob, filename: string): void {
	...
	// Never skip the attach: a detached anchor is the Firefox no-op this helper
	// exists to remove, and falling back to it silently would be worse than the
	// bug it replaced. `documentElement` always exists by the time any of this
	// runs.
