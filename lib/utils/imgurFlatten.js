...
// Both probed returning 200 on 2026-08-07 via `yarn check:endpoints`.
// rimgo.pussthecat.org was a candidate third but answers a scripted probe with
// 418, so it could not be verified — and shipping an unverified host is the
// exact mistake the two previous dead defaults were. Users can add it manually.
