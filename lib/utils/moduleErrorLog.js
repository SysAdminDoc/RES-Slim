...
export function hasEquivalentModuleError(rawEntries: mixed, entry: ModuleErrorEntry): boolean {
	return normalizeModuleErrorEntries(rawEntries).some(existing => (
		existing.moduleID === entry.moduleID &&
