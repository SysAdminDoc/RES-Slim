...
// --- contrast maths ---
//
// Exported for the contrast contracts and, since `voteEnhancements` began
// choosing a readable ink for the rank badge, for the content script on every
// listing. Anything changed here is changed for a rendering path, not only for
// a test.
...
// The inverse of `hslToRgb`, and it lives here for the same reason: two callers
// now want it -- `pageTheme` to move an accent's lightness until it is readable,
// and `voteEnhancements` to do the same to a score colour -- and a second copy
