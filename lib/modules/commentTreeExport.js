...
export const module: Module<{ [string]: any }> = new Module('commentTreeExport');
...
module.options = {
	htmlOpenInNewTab: {
		...
		description: 'Open the HTML export in a new tab in addition to downloading. Disable for download-only behavior.',
	},
};
