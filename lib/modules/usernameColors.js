...
module.moduleName = 'Color usernames';
module.category = 'usersCategory';
module.description = 'Gives every author a stable color derived from their name, so the same person is recognisable at a glance through a long thread. The color never changes between page loads.';
...
module.options = {
	colorComments: {
		type: 'boolean',
		value: true,
		title: 'Color comment authors',
		description: 'Apply the color to author links in comment taglines.',
	},
	colorPosts: {
		type: 'boolean',
		value: true,
		title: 'Color post authors',
		description: 'Apply the color to author links on listing and search pages.',
	},
	palette: {
		type: 'enum',
		value: 'dark',
	...
	boldAuthor: {
		...
		description: 'Useful when the color alone is too subtle at small sizes.',
	},
};
