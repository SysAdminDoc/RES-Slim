...
module.description = 'Gives every author a stable color derived from their name, so the same person is recognizable at a glance through a long thread. The color never changes between page loads.';
