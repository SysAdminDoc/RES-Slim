...
export const module: Module<*> = new Module('repostDedupe');

module.moduleName = 'Repost dedupe';
module.category = 'submissionsCategory';
module.description = 'Collapse repeat appearances of the same media in a feed. Keys each post by its normalised link/thumbnail; the first appearance is untouched, later duplicates are dimmed, hidden, or badged. Local-only, no network.';
