...
module.options = {
	mirror: {
		type: 'text',
		value: 'https://rimgo.totaldarkness.net',
		title: 'Mirror base URL',
		description: 'Public rimgo (or compatible) instance. Trailing slash optional. The default is a known rimgo instance; check `https://github.com/rimgo/instances` for the current public list.',
	},
	rewriteTitle: {
		type: 'boolean',
		value: true,
