...
module.sort = -9;
module.description = `
	<p>Search by module name, setting name, or description.</p>
	...
	<div id="SearchRES-boilerplate">
		<p>Try a feature name, a module name, or part of a setting description.</p>
		<ul>
			<li>Examples: <code>timestamps</code>, <code>favicon</code>, or <code>subreddit styles</code></li>
			<li>Turn on advanced options from the left rail to include expert settings in the results</li>
			<li>Use the copy button on a result to link directly to that setting in a comment</li>
		</ul>
	</div>
`;
...
const searchResultTemplate = ({ title, category, description, moduleName, moduleID, optionName, optionKey }) => string.html`
	<a class="SearchRES-result-link" href="${SettingsNavigation.makeUrlHash(moduleID, optionKey)}" aria-label="Open ${title} in settings">
