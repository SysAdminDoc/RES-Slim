...
function drawSearchResults(query, results: Array<*>) {
	...
	$resultsContainer.off('.searchResults')
		.on('click.searchResults', '.SearchRES-result-copybutton', handleSearchResultCopyClick);
...
function handleSearchResultCopyClick(event: any) {
	...
	const parent = downcast(this.closest('li'), HTMLElement);
