...
module.description = 'Records every vote you cast on classic or current Reddit to IndexedDB along with a snippet, the score-at-time, and a timestamp. Browseable + exportable. Nothing leaves the browser.';
...
function readSnippet(thingEl: HTMLElement): string {
	...
	const currentTitle = thingEl.querySelector('[slot="title"]');
...
function injectTrigger(): void {
	...
	const userbar = document.querySelector('#header-bottom-right, reddit-header-large > header');
