...
export const module: Module<*> = new Module('mediaScopeToggle');

module.moduleName = 'Post / comment media scope';
module.category = 'productivityCategory';
module.description = 'Independently disable inline media on posts only, or on comments only. The opposite surface keeps the existing `showImages` behaviour. Useful when comments are full of distracting GIFs but you still want post expandos.';
...
module.options = {
	...
	suppressInComments: {
		...
		description: 'Hide the inline expando-button and any expanded media inside comment trees. Most useful default — comment galleries are the noisier surface.',
	},
	keepThumbnail: {
		type: 'boolean',
		value: true,
