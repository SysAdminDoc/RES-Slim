...
export const module: Module<{ [string]: any }> = new Module('commentDepthColors');
...
module.options = {
	...
	maxDepth: {
		type: 'text',
		value: '8',
		title: 'Max depth to color',
		description: 'After this depth the color cycles back through the palette.',
	},
};
