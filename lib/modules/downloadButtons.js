...
function makeButton(src: string): HTMLElement {
	const btn = string.html`<a class="res-slim-download-btn" title="Download" style="margin-left:6px; font-size:11px;" href="${directUrl(src)}" download="${filenameFor(directUrl(src))}" target="_blank" rel="noopener">\u2B07 download</a>`;
	return btn;
}
