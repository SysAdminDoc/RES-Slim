...
import { basenameFor } from '../utils/downloadFilename';

export const module: Module<{ [string]: any }> = new Module('downloadButtons');
...
function makeButton(src: string): HTMLElement {
	...
	return string.html`<a class="res-slim-download-btn" title="Download" style="margin-left:6px; font-size:11px;" href="${url}" download="${basenameFor(url)}" target="_blank" rel="noopener">\u2B07 download</a>`;
}
