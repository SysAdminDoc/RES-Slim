...
export const module: Module<*> = new Module('searchScope');
...
module.options = {
	...
	legacySearch: {
		...
		description: 'Adds <code>feature=legacy_search</code>. The old backend honours quoted phrases and field queries that the current one silently ignores.',
	},
};
