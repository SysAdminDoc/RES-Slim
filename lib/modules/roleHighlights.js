...
export const module: Module<{ [string]: any }> = new Module('roleHighlights');

module.moduleName = 'Role highlight lanes';
module.category = 'commentsCategory';
module.description = 'Refresh OP / moderator / admin / friend highlight lanes with per-role color pickers, an optional backdrop tint, and an optional animated role-flair shimmer.';
...
module.options = {
	highlightOP: {
		...
		description: 'Color-tag the comment author who submitted the post.',
	},
	opColor: {
		type: 'color',
		value: '#3b82f6',
		title: 'OP color',
		description: 'Accent color for the OP role lane.',
	},
	highlightMod: {
		type: 'boolean',
		value: true,
		title: 'Highlight moderators',
		description: 'Color-tag moderators of the current subreddit.',
	},
	modColor: {
		type: 'color',
		value: '#22c55e',
		title: 'Moderator color',
		description: 'Accent color for the moderator role lane.',
	},
	highlightAdmin: {
		type: 'boolean',
		value: true,
		title: 'Highlight admins',
		description: 'Color-tag site admins.',
	},
	adminColor: {
		type: 'color',
		value: '#ef4444',
		title: 'Admin color',
		description: 'Accent color for the admin role lane.',
	},
	highlightFriend: {
		type: 'boolean',
		value: false,
		title: 'Highlight friends',
		description: 'Color-tag users marked as friend.',
	},
	friendColor: {
		type: 'color',
		value: '#a855f7',
		title: 'Friend color',
		description: 'Accent color for the friend lane.',
	},
	animateRoleFlair: {
		type: 'boolean',
		value: false,
