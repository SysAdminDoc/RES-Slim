...
const saveElement = (e => () => preventCloning(e().cloneNode(true)))(once(() => {
	...
	return string.html`
		<li class="saveComments">
			<a class="RES-save noCtrlF" href="#" title="Save using RES-Slim, which is local only but preserves the full text if someone edits or deletes it" data-text="save-RES"></a>
		</li>
	`;
}));
