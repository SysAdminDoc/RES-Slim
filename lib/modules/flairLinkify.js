...
export const module: Module<*> = new Module('flairLinkify');
...
module.options = {
	...
	linkUserFlair: {
		...
		description: 'User flair is not indexed, so this links to that author\'s posts in the subreddit instead — useful on subreddits where flair marks a role.',
	},
	openInNewTab: {
		type: 'boolean',
		value: true,
