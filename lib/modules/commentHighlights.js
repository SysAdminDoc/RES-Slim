...
export const module: Module<{ [string]: any }> = new Module('commentHighlights');
...
const store = Storage.wrapFeatureBlob('commentHighlights', 'RESmodules.commentHighlights.lastVisit', (): number => 0);
