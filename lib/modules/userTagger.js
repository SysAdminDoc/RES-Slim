...
module.description = 'Tag users with a label, a colour, and/or an ignore flag. Tags are stored locally in ordinary windows; private-window edits last only for the page. Imports are previewed before one atomic commit.';
