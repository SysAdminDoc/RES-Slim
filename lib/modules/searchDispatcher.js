...
export const module: Module<*> = new Module('searchDispatcher');
...
type Target = {| key: string, label: string, template: string |};

const DEFAULT_TARGETS: $ReadOnlyArray<Target> = Object.freeze([
	{ key: 'reddit', label: 'Reddit', template: 'https://old.reddit.com/search?q={q}' },
	{ key: 'sub', label: 'This subreddit', template: '{sub}/search?q={q}&restrict_sr=on' },
	{ key: 'google-site', label: 'Google · site:reddit.com', template: 'https://www.google.com/search?q=site%3Areddit.com+{q}' },
	{ key: 'ddg-site', label: 'DuckDuckGo · site:reddit.com', template: 'https://duckduckgo.com/?q=site%3Areddit.com+{q}' },
]);
