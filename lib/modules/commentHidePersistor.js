...
export const module: Module<{ [string]: any }> = new Module('commentHidePersistor');
...
const entryStorage = Storage.wrapFeaturePrefix('commentHidePersistor', 'commentHidePersistor.', (): {
	updateTime: number,
...
function listenToCommentCollapse() {
	document.body.addEventListener('click', (e: MouseEvent) => {
		if (!(e.target instanceof Element) || !e.target.closest('a.expand')) return;
		Object.defineProperty(e, 'currentTarget', { value: e.target.closest('a.expand') });
