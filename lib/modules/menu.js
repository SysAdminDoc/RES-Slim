...
export const module: Module<{ [string]: any }> = new Module('RESMenu');

module.moduleName = 'menuName';
module.category = 'coreCategory';
module.description = 'The <span class="gearIcon"></span> button that opens the RES-Slim settings console';
...
export function addMenuItem(getElement: () => HTMLElement, onClick: (e: Event) => void = () => undefined, order: number = 0) {
	if (typeof getElement !== 'function' || typeof onClick !== 'function' || typeof order !== 'number') {
		return undefined;
	}
