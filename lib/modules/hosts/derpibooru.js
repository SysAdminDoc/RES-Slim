...
import { keyBy } from '../../utils/functional';
...
export default new Host('derpibooru', {
	...
	// `Access-Control-Allow-Origin: *`, so no host permission is needed. Note the
	// v2 endpoint this handler calls answered 400 on the same day; see ROADMAP.
		'derpibooru.org',
		'trixiebooru.org',
