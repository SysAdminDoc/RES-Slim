...
export default new Host('onedrive', {
	...
	// cors: measured 2026-09-02 - api.onedrive.com answers 400/401 to an unauthenticated
	// probe with no Access-Control-Allow-Origin. Declared rather than assumed.
	permissions: ['https://api.onedrive.com/v1.0/shares/*'],
