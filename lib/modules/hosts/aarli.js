...
export default new Host('aarli', {
	name: 'AAR Library',
	domains: ['aar.li'],
	// cors: measured 2026-09-02 - aar.li answers 200 with no Access-Control-Allow-Origin,
	// so this needs the host permission below.
	permissions: ['https://aar.li/api.php*'],
