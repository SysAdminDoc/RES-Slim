...
// naming that route would have taken a working expando away. `shorts` is not
// listed: it has its own branch below and returns before this is reached, so an
// alternation for it would be a route nothing can take.
const VIDEO_PATH = /^(watch|embed|v|live)$/i;
