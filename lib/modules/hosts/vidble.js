...
export default new Host('vidble', {
	name: 'vidble',
	domains: ['vidble.com'],
	// cors: measured 2026-09-02 - vidble.com answers 200 with no
	// Access-Control-Allow-Origin, so the album JSON needs the host permission.
	permissions: ['https://vidble.com/album/*'],
