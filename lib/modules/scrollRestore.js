...
export const module: Module<{ [string]: any }> = new Module('scrollRestore');
...
module.options = {
	maxEntries: {
		...
		description: 'How many pages to remember a scroll position for. The oldest is forgotten first.',
	},
};
