/* @flow */
// RES-Slim: remember the scroll position per permalink so coming back to a
...
module.description = 'Remember where you were on each thread / listing and scroll back to that position when you revisit.';
