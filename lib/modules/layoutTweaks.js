...
export const module: Module<*> = new Module('layoutTweaks');

module.moduleName = 'Layout tweaks';
module.category = 'appearanceCategory';
module.description = 'Full-width feed, sidebar collapse, post numbering, and granular icon/avatar/flair/award hide switches.';
...
const RULES: $ReadOnlyArray<{| key: string, className: string, css: string |}> = Object.freeze([
	{
		...
		css: 'body.rsm-layout-full-width .content[role="main"] { max-width: none !important; margin-right: 12px !important; }',
	},
	{
		key: 'hideSidebar',
		className: 'rsm-layout-hide-sidebar',
		css: 'body.rsm-layout-hide-sidebar .side { display: none !important; } body.rsm-layout-hide-sidebar .content[role="main"] { margin-right: 12px !important; }',
	},
	{
		key: 'postNumbers',
		className: 'rsm-layout-post-numbers',
		css: '.rsm-layout-post-numbers #siteTable.linklisting { counter-reset: rsm-post-counter; } .rsm-layout-post-numbers #siteTable.linklisting > .thing.link { counter-increment: rsm-post-counter; position: relative; } .rsm-layout-post-numbers #siteTable.linklisting > .thing.link::before { content: counter(rsm-post-counter); position: absolute; left: -36px; top: 8px; min-width: 24px; padding: 2px 6px; border-radius: 4px; background: rgb(255 122 24 / 16%); color: #ffb06a; font-weight: 600; font-size: 11px; text-align: center; }',
	},
	{
		key: 'hideAwards',
		className: 'rsm-layout-hide-awards',
		css: '.rsm-layout-hide-awards .awardings-bar, .rsm-layout-hide-awards .awardings-icon, .rsm-layout-hide-awards .award { display: none !important; }',
	},
	{
		key: 'hideFlair',
		className: 'rsm-layout-hide-flair',
		css: '.rsm-layout-hide-flair .flair { display: none !important; }',
	},
	{
		key: 'hideLinkFlair',
		className: 'rsm-layout-hide-link-flair',
		css: '.rsm-layout-hide-link-flair .linkflairlabel { display: none !important; }',
	},
	{
		key: 'hideAvatars',
		className: 'rsm-layout-hide-avatars',
		css: '.rsm-layout-hide-avatars img.snoovatar, .rsm-layout-hide-avatars .avatar { display: none !important; }',
	},
]);
