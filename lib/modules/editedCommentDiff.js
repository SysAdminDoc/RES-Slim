...
export const module: Module<{ [string]: any }> = new Module('editedCommentDiff');

module.moduleName = 'Edited comment diff';
module.category = 'commentsCategory';
module.description = 'On comments marked "edited", add a link that fetches the archived original from Arctic Shift (PullPush fallback) and shows a word-level diff against the current text. Local-only in what it stores, but it fetches from an external archive. Defaults off.';
