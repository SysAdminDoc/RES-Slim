...
export const module: Module<{ [string]: any }> = new Module('autoLoadMoreComments');
...
module.options = {
	...
	requestsPerSecond: {
		...
		title: 'Request rate',
		description: 'How quickly to open the "load more comments" links. Reddit rate-limits them hard, so a slower setting usually finishes sooner.',
	},
	skipDeepThreads: {
		type: 'boolean',
		value: false,
		title: 'Skip "continue this thread" stubs',
		description: 'Those links open a new page instead of expanding in place. Leave this on if you use Continue thread inline, which opens them where they are.',
	},
};
