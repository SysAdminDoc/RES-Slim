...
import { watchForThings, watchForFutureDescendants } from '../utils';
...
function ensureBadge(): ?HTMLElement {
	...
	const host = document.getElementById('header-bottom-right') || document.querySelector('#header .tabmenu, reddit-header-large > header');
