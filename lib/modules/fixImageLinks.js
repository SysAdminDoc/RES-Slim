...
export const module: Module<{ [string]: any }> = new Module('fixImageLinks');

module.moduleName = 'Fix broken image links';
module.category = 'appearanceCategory';
module.description = 'Rewrites i.redd.it and preview.redd.it links so they open the image itself instead of current Reddit\'s media viewer.';
