...
module.contentStart = () => {
	...
	const up = string.html`<button type="button" aria-label="Previous top-level comment" title="Previous top-level comment" style="padding:6px 10px;">\u25B2</button>`;
	const down = string.html`<button type="button" aria-label="Next top-level comment" title="Next top-level comment" style="padding:6px 10px;">\u25BC</button>`;
