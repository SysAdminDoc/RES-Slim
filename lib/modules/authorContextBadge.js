...
import { fetchRedditJson, isJsonObject } from '../utils/redditJson';
import {
	ageRiskClass,
	formatBadge,
	isFresh,
...
export const module: Module<{ [string]: any }> = new Module('authorContextBadge');
...
module.options = {
	...
	cacheHours: {
		...
		description: 'How long to trust a cached /user/<u>/about.json response before re-fetching. Defaults to 24 hours.',
	},
	skipDeleted: {
		type: 'boolean',
		value: true,
...
const store = Storage.wrapFeatureBlob('authorContextBadge', 'RESmodules.authorContextBadge.cache', (): AuthorAbout | null => null);
