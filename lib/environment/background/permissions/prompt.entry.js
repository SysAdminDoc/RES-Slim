...
const PERMISSION_LABELS = {
	...
	geolocation: 'Read your approximate location',
...
function finishPrompt(result: boolean) {
	...
	setPromptStatus(
		result
			? 'Access granted. Returning to RES-Slim…'
			: 'Access was not granted. Returning to RES-Slim — the feature that asked for it stays off, and everything else keeps working.',
