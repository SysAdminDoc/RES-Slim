...
export const SETTINGS_THEME_PRESETS = Object.freeze([
	...
	{ id: 'catppuccin', labelKey: 'settingsConsoleThemeCatppuccin', metaColor: '#1e1e2e' },
	{ id: 'tokyonight', labelKey: 'settingsConsoleThemeTokyoNight', metaColor: '#1a1b26' },
	{ id: 'rosepine', labelKey: 'settingsConsoleThemeRosePine', metaColor: '#191724' },
]);
