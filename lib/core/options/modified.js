...
import { isEmpty, isEqual, omitBy } from '../../utils/functional';
import * as Modules from '../modules';
import { niceKeyCode, filterMap } from '../../utils';

// Exported for the console's "Modified" filter chip, which counted staged
// changes alone and so emptied itself the moment they were saved.
