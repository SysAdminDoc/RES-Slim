...
function renderActionLog() {
	...
	if (!rows.length) {
		status.textContent = i18n('settingsConsoleActionLogEmpty');
		return;
	}
	...
	table.append(body);
	list.append(table);
	status.textContent = i18n('settingsConsoleActionLogCount', String(rows.length), String(actionLogEntries.length));
}
