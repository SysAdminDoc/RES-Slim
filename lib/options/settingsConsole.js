...
function updateSaveButton() {
	...
	if (saveButton) {
		...
		saveButton.textContent = unsavedOptions ? pluralI18n(changeCount, 'settingsConsoleSaveStagedOne', 'settingsConsoleSaveStagedMany', changeCount) : defaultSaveLabel;
		const saveLabel = unsavedOptions ? pluralI18n(changeCount, 'settingsConsoleSaveStagedAriaOne', 'settingsConsoleSaveStagedAriaMany', changeCount) : defaultSaveLabel;
