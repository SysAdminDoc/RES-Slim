...
function settingsStatus(message: string, closeDelay: number = 2400) {
...
async function copyModuleErrorLog() {
	...
	try {
		...
		output.focus();
		output.select();
		settingsStatus(i18n('settingsConsoleErrorsCopyFailed'));
	}
}
...
async function copySupportReport() {
	...
	try {
		...
		output.focus();
		output.select();
		settingsStatus(i18n('settingsConsoleSupportCopyFailed'));
	}
}
...
async function clearModuleErrors() {
	try {
		...
		settingsStatus(i18n('settingsConsoleErrorsClearFailed'));
	}
}
