		...
		<div id="RESConsoleHeader">
			<div id="RESConsoleTopBar" class="RESDialogTopBar">
				...
				<div class="consoleHeaderActions">
					...
					<div class="consoleControlGroup" role="group" aria-label="${i18n('settingsConsoleDisplayGroup')}">
					...
					<div class="consoleControlGroup" role="group" aria-label="${i18n('settingsConsoleSettingsFileGroup')}">
