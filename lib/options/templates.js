			...
			<aside id="RESConfigPanelModulesPane" aria-label="Settings modules">
				<div class="sidebarDeck">
					<section class="sidebarSection sidebarCommandDeck">
						...
						<div id="RESFilterChips" class="filterChips" role="group" aria-label="Filter modules by state">
					...
					<section class="sidebarSection sidebarModules">
						...
						<div id="RESConfigPanelModulesEmpty" class="sidebarEmptyState" hidden role="status">
							<p class="sidebarEmptyStateTitle">No modules match this filter.</p>
							<button type="button" class="sidebarEmptyStateReset" data-filter="all">Show all modules</button>
						</div>
					</section>
