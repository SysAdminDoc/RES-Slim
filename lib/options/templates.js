...
import { DEFAULT_SETTINGS_THEME, SETTINGS_THEME_PRESETS } from '../constants/settingsThemes';
import { CONSOLE_PREFS_TAB_ID, SEARCH_TAB_ID } from '../constants/settingsCategories';
				...
				<section id="RESSelectorDrift" class="selectorDriftPanel" hidden aria-labelledby="RESSelectorDriftTitle">
					<header class="selectorDriftHeader">
						...
						<div class="selectorDriftActions">
							<button id="RESSelectorDriftCopy" type="button" class="selectorDriftButton">Copy report</button>
							<button id="RESSelectorDriftClear" type="button" class="selectorDriftButton selectorDriftButton--quiet">Clear</button>
						</div>
					</header>
					<p class="selectorDriftSummary">Old Reddit's markup moved under a feature that depends on it. Nothing is broken yet — these surfaces resolved through a backup selector, or not at all. Recorded on this device only; no URLs, subreddits or account details are kept.</p>
			...
			<section id="RESConsolePrefs" class="consolePrefsShell" role="tabpanel" hidden>
				...
				<div class="consolePrefsGrid">
					...
					<section id="RESSelectorOverridePanel" class="utilityPanel utilityPanel--selectors" aria-labelledby="RESSelectorOverrideTitle">
						<div class="utilityPanelHeader">
							<span id="RESSelectorOverrideTitle" class="utilityPanelTitle">Selector repair</span>
							<span class="utilityPanelMeta">Advanced local repair for Reddit markup changes</span>
						</div>
						<p class="selectorOverrideSummary">Override a named surface when Reddit changes its markup. Only known surfaces and valid CSS selectors can be saved. Overrides stay on this device and take priority over the bundled selector file.</p>
						<label class="selectorOverrideLabel" for="RESSelectorOverrideEditor">Override JSON</label>
						...
						<div class="utilityActionStack consoleControlGroup" role="group" aria-label="Selector override actions">
							<button id="RESSelectorOverrideSave" type="button" class="settingsIoButton">Save overrides</button>
							<button id="RESSelectorOverrideImport" type="button" class="settingsIoButton">Import JSON</button>
							<button id="RESSelectorOverrideExport" type="button" class="settingsIoButton">Export JSON</button>
							<button id="RESSelectorOverrideReset" type="button" class="settingsIoButton">Restore bundled</button>
